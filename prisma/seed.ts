...
const MODULES_ACTIONS: Record<string, string[]> = {
  ...
  integration: ["view", "create", "update", "test", "logs", "retry", "credentials", "webhooks_manage", "documentation", "mapping_manage", "import_export", "health"],
};
...
const ROLES: {
  ...
  },
  {
    ...
    permissions: [
      ...
      "integration:view", "integration:create", "integration:update", "integration:test", "integration:logs", "integration:retry", "integration:credentials", "integration:webhooks_manage", "integration:documentation", "integration:mapping_manage", "integration:import_export", "integration:health",
    ],
  },
  {
    code: "MAYOR",
