...
const MODULES_ACTIONS: Record<string, string[]> = {
  ...
  integration: ["view", "create", "update", "test", "logs", "retry", "credentials", "webhooks_manage"],
};
...
const ROLES: {
  ...
  },
  {
    ...
    permissions: [
      ...
      "integration:view", "integration:create", "integration:update", "integration:test", "integration:logs", "integration:retry", "integration:credentials", "integration:webhooks_manage",
    ],
  },
  {
    code: "MAYOR",
