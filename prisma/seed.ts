...
const MODULES_ACTIONS: Record<string, string[]> = {
  ...
  births: ["view", "create", "validate", "revoke"],
  recognitions: ["view", "create", "validate"],
  marriages: ["view", "create", "validate"],
  divorces: ["view", "create", "validate"],
  deaths: ["view", "create", "validate"],
...
const ROLES: {
  ...
  },
  {
    ...
    permissions: [
      ...
      "citizens:view", "households:view", "births:view", "recognitions:view",
