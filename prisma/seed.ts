...
const MODULES_ACTIONS: Record<string, string[]> = {
  ...
  businesses: ["view", "create", "edit", "transfer"],
  ...
  complaints: ["view", "assign", "update", "resolve", "reject", "manage_categories", "export"],
  ...
  integration: ["view", "create", "update", "test", "logs", "retry", "credentials", "webhooks_manage", "documentation", "mapping_manage", "import_export", "health", "sync_manage"],
};
...
const ROLES: {
  ...
  },
  {
    ...
    permissions: [
      ...
      "businesses:view", "businesses:create", "businesses:edit", "businesses:transfer", "markets:view", "markets:create", "markets:edit",
      ...
      "complaints:view", "complaints:assign", "complaints:update", "complaints:resolve", "complaints:reject", "complaints:export",
      ...
      "integration:view", "integration:create", "integration:update", "integration:test", "integration:logs", "integration:retry", "integration:credentials", "integration:webhooks_manage", "integration:documentation", "integration:mapping_manage", "integration:import_export", "integration:health", "integration:sync_manage",
    ],
  },
  {
    code: "MAYOR",
