      ...
      <div className="relative w-full max-w-sm">
        <div className="overflow-hidden rounded-3xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-xl">
          <div className="px-7 pb-6 pt-8 text-center sm:px-9">
            ...
            <h1 className="text-lg font-semibold text-white">Espace citoyen</h1>
            <p className="mt-1 text-xs text-white/60">Ville de N&apos;Djamena</p>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-white/60">
          ...
          <Link href="/portail/register" className="font-medium text-white hover:underline">
            Creer un compte
          </Link>
        </p>
      </div>
