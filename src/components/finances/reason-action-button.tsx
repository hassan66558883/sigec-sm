...
// Meme convention que civil-status/revoke-button.tsx (champ de motif inline,
// jamais un prompt() natif) — generalisee a n'importe quelle action PATCH
// avec motif obligatoire (annulation paiement/obligation, annulation reçu).
