// Petites icones ligne (SVG inline, currentColor) — pas de dependance externe
// ajoutee au projet, juste pour l'espace TECHNOTCHAD.
...
export function IconKey({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={base} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M11 12l8-8M16 5l2 2M19 2l3 3" />
    </svg>
  );
}
